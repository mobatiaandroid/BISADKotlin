...
import com.mobatia.bisad.fragment.time_table.model.apimodel.FieldApiListModel
import com.mobatia.bisad.fragment.time_table.model.usagemodel.PeriodModel
import com.ryanharter.android.tooltips.ToolTip
import com.ryanharter.android.tooltips.ToolTipLayout

 var isClick:Boolean=false
class TimeTableAllWeekSelectionAdapterNew (private var mContext:Context, private var mPeriodModel: List<PeriodModel>,var timeTableAllRecycler:RecyclerView,var tipContainer: ToolTipLayout,private var mFeildList:List<FieldApiListModel>) :
...
//                holder.countFTextView.visibility=View.VISIBLE
           ...
           holder.tutor1.setOnClickListener(View.OnClickListener {
               ...
               if (holder.tutor1.text.equals(""))
               {
                   ...
                   val mTimeTablePopUpRecyclerAdapter =
                       TimeTablePopUpRecyclerAdapter(mContext, mPeriodModel.get(position).timeTableListS)
        ...
        holder.tutor2.setOnClickListener(View.OnClickListener {
            if (holder.tutor2.text.equals(""))
            {
                ...
                recycler_view_timetable.layoutManager = llmAtime
                val mTimeTablePopUpRecyclerAdapter =
                    TimeTablePopUpRecyclerAdapter(mContext, mPeriodModel.get(position).timeTableListM)
                mTimeTablePopUpRecyclerAdapter.notifyDataSetChanged()
                recycler_view_timetable.adapter = mTimeTablePopUpRecyclerAdapter
                var t: ToolTip? = null
                t = if (position == 0) {
        ...
        holder.tutor3.setOnClickListener(View.OnClickListener {
            if (holder.tutor3.text.equals(""))
            {
                ...
                recycler_view_timetable.layoutManager = llmAtime
                val mTimeTablePopUpRecyclerAdapter =
                    TimeTablePopUpRecyclerAdapter(mContext, mPeriodModel.get(position).timeTableListTu)
                mTimeTablePopUpRecyclerAdapter.notifyDataSetChanged()
                recycler_view_timetable.adapter = mTimeTablePopUpRecyclerAdapter
                var t: ToolTip? = null
                t = if (position == 0) {
        ...
        holder.tutor4.setOnClickListener(View.OnClickListener {
            if (holder.tutor4.text.equals(""))
            {
                ...
                recycler_view_timetable.layoutManager = llmAtime
                val mTimeTablePopUpRecyclerAdapter =
                    TimeTablePopUpRecyclerAdapter(mContext, mPeriodModel.get(position).timeTableListW)
                mTimeTablePopUpRecyclerAdapter.notifyDataSetChanged()
                recycler_view_timetable.adapter = mTimeTablePopUpRecyclerAdapter
                var t: ToolTip? = null
                t = if (position == 0) {
        ...
        holder.tutor5.setOnClickListener(View.OnClickListener {
            if (holder.tutor5.text.equals(""))
            {
                ...
                recycler_view_timetable.layoutManager = llmAtime
                val mTimeTablePopUpRecyclerAdapter =
                    TimeTablePopUpRecyclerAdapter(mContext, mPeriodModel.get(position).timeTableListTh)
                mTimeTablePopUpRecyclerAdapter.notifyDataSetChanged()
                recycler_view_timetable.adapter = mTimeTablePopUpRecyclerAdapter
                var t: ToolTip? = null
                t = if (position == 0) {
